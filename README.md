...
5. Make sure to follow the Heroku deploy commands 

6. For NodeJS troubleshooting purposes, go to [HEROKU NodeJS Support](https://devcenter.heroku.com/articles/nodejs-support#specifying-a-node-js-version)
